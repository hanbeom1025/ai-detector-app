...
# ==========================================
# 🔒 [보안 적용] 구글 Gemini API 키 설정 및 모델 초기화
# ==========================================
# 배포 서버의 Secrets 시스템이나 로컬 .streamlit/secrets.toml을 참조합니다.
if "GEMINI_API_KEY" in st.secrets:
    genai.configure(api_key=st.secrets["GEMINI_API_KEY"])
else:
    st.warning("⚠️ API Key가 설정되지 않았습니다. 서비스가 정상 작동하지 않을 수 있습니다.")
    genai.configure(api_key="DUMMY_KEY_FOR_LOCAL_TEST")

# 텍스트 및 이미지 분석용 모델
model = genai.GenerativeModel('gemini-2.5-flash-lite')

# ==========================================
# 📂 [경로 수정] 코드에서 관리하는 이미지 가イド라인 (상대 경로)
# ==========================================
IMAGE_GUIDELINES = [
    "images/AI 생성물 판별 가이드라인 p.1.png",
    "images/AI 생성물 판별 가이드라인 p.2.png",
    "images/AI 생성물 판별 가이드라인 p.3.png",
    "images/AI 생성물 판별 가이드라인 p.4.png",
    "images/AI 생성물 판별 가이드라인 p.5.png",
    "images/AI 생성물 판별 가이드라인 p.6.png",
    "images/AI 생성물 판별 가이드라인 p.7.png"
]
...
# --- 3. AI 판별 퀴즈 (경로 수정 완료) ---
    ...
    quiz_data = [
        ...
        {"type": "image", "content": "images/사진1.jpg", "answer": "Human", "reason": "인물들의 표정이 매우 현실적이며, 옷의 글자들이 정확합니다."},
        {"type": "image", "content": "images/사진2.jpg", "answer": "AI", "reason": "그림자가 매우 부자연스럽습니다."},
        {"type": "image", "content": "images/사진4.jpg", "answer": "AI", "reason": "사진 속 요소가 지나치게 선명하다."},
        {"type": "image", "content": "images/사진5.jpg", "answer": "Human", "reason": "햇빛의 경로들이 매우 자연스럽습니다."},
        {"type": "image", "content": "images/사진6.jpg", "answer": "AI", "reason": "ppt의 사진이 일그러져 있습니다."},
        {"type": "image", "content": "images/사진7.jpg", "answer": "Human", "reason": "우비의 움직임과 빗물의 표현이 자연스럽습니다."},
        {"type": "image", "content": "images/사진8.jpg", "answer": "AI", "reason": "간판의 글자들이 일그러져 있습니다. "},
        {"type": "image", "content": "images/사진9.jpg", "answer": "AI", "reason": "눈이 내리는 표현이 부자연스럽습니다."},
        {"type": "image", "content": "images/사진10.jpg", "answer": "Human", "reason": "구름의 표현이 현실과 매우 유사합니다."}
    ]
    ...
    if idx < total_q:
        ...
        if current_q["type"] == "text":
            ...
            try:
                ...
                st.error("이미지 파일을 찾을 수 없습니다. 'images' 폴더 내 파일 유무를 확인하세요.")
