...
# ==========================================
# 유저들이 학습할 가이드라인 이미지 경로만 순서대로 적어주세요.
IMAGE_GUIDELINES = [
    r"C:\Users\LG\Downloads\AI 생성물 판별 가이드라인 p.1.png",
    r"C:\Users\LG\Downloads\AI 생성물 판별 가이드라인 p.2.png",
    r"C:\Users\LG\Downloads\AI 생성물 판별 가이드라인 p.3.png",
    r"C:\Users\LG\Downloads\AI 생성물 판별 가이드라인 p.4.png",
    r"C:\Users\LG\Downloads\AI 생성물 판별 가이드라인 p.5.png",
    r"C:\Users\LG\Downloads\AI 생성물 판별 가이드라인 p.6.png",
    r"C:\Users\LG\Downloads\AI 생성물 판별 가이드라인 p.7.png"
...
def analyze_with_gemini(data, data_type):
    try:
        ...
        score_str = ''.join(filter(str.isdigit, lines[0]))
        score = int(score_str) if score_str else 50
        reason = lines[1].replace('근거:', '').strip() if len(lines) > 1 else "근거 추출 실패"
...
# --- 3. AI 판별 퀴즈 ---
    ...
    quiz_data = [
        ...
        {
            "type": "image", 
            "content": r"C:\Users\LG\OneDrive\Desktop\사진들\KakaoTalk_20260604_172737586.jpg", 
            "answer": "Human", 
            "reason": "인물들의 표정이 매우 현실적이며, 옷의 글자들이 정확합니다."
        },
        {
            "type": "image", 
            "content": r"C:\Users\LG\OneDrive\Desktop\사진들\KakaoTalk_20260604_172737586_01.jpg", 
            "answer": "AI", 
            "reason": "그림자가 매우 부자연스럽습니다."
        },
        {
            "type": "image", 
            "content": r"C:\Users\LG\OneDrive\Desktop\사진들\KakaoTalk_20260604_172737586_03.jpg", 
            "answer": "AI", 
            "reason": "사진 속 요소가 지나치게 선명하다."
        },
        {
            "type": "image", 
            "content": r"C:\Users\LG\OneDrive\Desktop\사진들\KakaoTalk_20260604_172737586_04.jpg", 
            "answer": "Human", 
            "reason": "햇빛의 경로들이 매우 자연스럽습니다."
        },
        {
            "type": "image", 
            "content": r"C:\Users\LG\OneDrive\Desktop\사진들\KakaoTalk_20260604_172737586_05.jpg", 
            "answer": "AI", 
            "reason": "ppt의 사진이 일그러져 있습니다."
        },
        {
            "type": "image", 
            "content": r"C:\Users\LG\OneDrive\Desktop\사진들\KakaoTalk_20260604_172737586_06.jpg", 
            "answer": "Human", 
            "reason": "우비의 움직임과 빗물의 표현이 자연스럽습니다."
        },
        {
            "type": "image", 
            "content": r"C:\Users\LG\OneDrive\Desktop\사진들\KakaoTalk_20260604_172737586_07.jpg", 
            "answer": "AI", 
            "reason": "간판의 글자들이 일그러져 있습니다. "
        },
        {
            "type": "image", 
            "content": r"C:\Users\LG\OneDrive\Desktop\사진들\KakaoTalk_20260604_173139087.jpg", 
            "answer": "AI", 
            "reason": "눈이 내리는 표현이 부자연스럽습니다."
        },
        {
            "type": "image", 
            "content": r"C:\Users\LG\OneDrive\Desktop\사진들\KakaoTalk_20260604_173154033.jpg", 
            "answer": "Human", 
